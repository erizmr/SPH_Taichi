...
if __name__ == "__main__":
    config = SimConfig(scene_file_path="./data/scenes/dragon_bath_dynamic.json")
    ...
    series_prefix = "dragon_bath_dynamic_output/object_{}_demo_test.ply"
    ...
    while window.running:
        ...
        if output_frames:
            if cnt % 100 == 0:
                window.write_image(f"dragon_bath_dynamic_output_img/{cnt:06}.png")
        if output_ply:
            if cnt % 100 == 0:
                obj_id = 0
                ...
                with open(f"dragon_bath_dynamic_output/obj_1_{cnt_ply:06}.obj", "w") as f:
